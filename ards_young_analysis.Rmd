...
**SENSIBILITY** : `r if (nrow(pat_ARDS)!=0 & nrow(test_ADRS_Pa02)!=0) {round(SEN_PaO2_ARDS,2)} else { print("No ARDS patient")}`

**PPV**         : `r if (nrow(pat_ARDS)!=0 & nrow(test_ADRS_Pa02)!=0) {round(PPV_PaO2_ARDS,2)} else { print("No ARDS patient")}`

**NPV**         : `r if (nrow(pat_ARDS)!=0 & nrow(test_ADRS_Pa02)!=0) {round(NPV_PaO2_ARDS,2)} else { print("No ARDS patient")}`

**SPECIFITY**   : `r if (nrow(pat_ARDS)!=0 & nrow(test_ADRS_Pa02)!=0) {round(SPE_PaO2_ARDS,2)} else { print("No ARDS patient")}`
...
**SENSIBILITY** : `r if (nrow(pat_ARDS)!=0 & nrow(test_ADRS_Pa02)!=0) {round(SEN_PaO2_ARDS_y,2)} else { print("No ARDS patient")}`

**PPV**         : `r if (nrow(pat_ARDS)!=0 & nrow(test_ADRS_Pa02)!=0) {round(PPV_PaO2_ARDS_y,2)} else { print("No ARDS patient")}`

**NPV**         : `r if (nrow(pat_ARDS)!=0 & nrow(test_ADRS_Pa02)!=0) {round(NPV_PaO2_ARDS_y,2)} else { print("No ARDS patient")}`

**SPECIFITY**   : `r if (nrow(pat_ARDS)!=0 & nrow(test_ADRS_Pa02)!=0) {round(SPE_PaO2_ARDS_y,2)} else { print("No ARDS patient")}`
