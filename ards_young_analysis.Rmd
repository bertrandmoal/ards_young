...
LocalPatientClinicalCourse=read.csv("//Zisilon03/N03iam1/INTERNES/BertrandMoal/covid19/covid_19/code/4c/phase_1_1/phase2/output/november2020/LocalPatientClinicalCourse.csv", na.strings = "1900-01-01")
LocalPatientObservations=read.csv("//Zisilon03/N03iam1/INTERNES/BertrandMoal/covid19/covid_19/code/4c/phase_1_1/phase2/output/november2020/LocalPatientObservations.csv",na.strings = '-999')
LocalPatientSummary=read.csv("//Zisilon03/N03iam1/INTERNES/BertrandMoal/covid19/covid_19/code/4c/phase_1_1/phase2/output/november2020/LocalPatientSummary.csv", na.strings = "1900-01-01")
...
## Diagnostic: Percentage of patient without any procedure
...
pre_hospit<-  LocalPatientObservations %>%
  dplyr::filter(concept_type %in% c("DIAG-ICD10","DIAG-ICD9") & days_since_admission< -6 ) %>%
...
### Elix score for commorbities comprises between -365 and -7 
...
### Elix  commorbities comprises between -365 and -7 in number  
