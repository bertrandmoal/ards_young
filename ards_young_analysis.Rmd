...
LocalPatientClinicalCourse=read.csv("/LocalPatientClinicalCourse.csv", na.strings = "1900-01-01")
LocalPatientObservations=read.csv("/LocalPatientObservations.csv",na.strings = '-999')
LocalPatientSummary=read.csv("/LocalPatientSummary.csv", na.strings = "1900-01-01")
