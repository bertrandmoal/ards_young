...
LocalPatientClinicalCourse=read.csv("//Zisilon03/N03iam1/INTERNES/BertrandMoal/covid19/covid_19/code/4c/phase_1_1/phase2/output/november/LocalPatientClinicalCourse.csv", na.strings =  '1/1/1900')
LocalPatientObservations=read.csv("//Zisilon03/N03iam1/INTERNES/BertrandMoal/covid19/covid_19/code/4c/phase_1_1/phase2/output/november/LocalPatientObservations.csv",na.strings = '-999')
LocalPatientSummary=read.csv("//Zisilon03/N03iam1/INTERNES/BertrandMoal/covid19/covid_19/code/4c/phase_1_1/phase2/output/november/LocalPatientSummary.csv",na.strings = '1/1/1900')
...
if (nrow(pat_ARDS)!=0) {round(SEN_PaO2_ARDS,2)} else { print("No ARDS patient")}

```

**SENSIBILITY** : `r if (nrow(pat_ARDS)!=0) {round(SEN_PaO2_ARDS,2)} else { print("No ARDS patient")}`

**PPV**         : `r if (nrow(pat_ARDS)!=0) {round(PPV_PaO2_ARDS,2)} else { print("No ARDS patient")}`

**NPV**         : `r if (nrow(pat_ARDS)!=0) {round(NPV_PaO2_ARDS,2)} else { print("No ARDS patient")}`

**SPECIFITY**   : `r if (nrow(pat_ARDS)!=0) {round(SPE_PaO2_ARDS,2)} else { print("No ARDS patient")}`
...
**SENSIBILITY** : `r if (nrow(pat_ARDS)!=0) {round(SEN_PaO2_ARDS_y,2)} else { print("No ARDS patient")}`

**PPV**         : `r if (nrow(pat_ARDS)!=0) {round(PPV_PaO2_ARDS_y,2)} else { print("No ARDS patient")}`

**NPV**         : `r if (nrow(pat_ARDS)!=0) {round(NPV_PaO2_ARDS_y,2)} else { print("No ARDS patient")}`

**SPECIFITY**   : `r if (nrow(pat_ARDS)!=0) {round(SPE_PaO2_ARDS_y,2)} else { print("No ARDS patient")}`
