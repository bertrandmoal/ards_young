...
out_phe_all <-diag_pheno %>%
  ...
  dplyr::summarise(value=n_distinct(patient_num))%>%
  dplyr::rename(concept=PheCode )%>%
  dplyr::mutate(variable="PheCode",
                periode_group="all",
                time="all")%>%
  data.frame()
...
out_phe=rbind(out_phe_all,out_phe_before,out_phe_after,out_phe_after90,out_phe_all_p,out_phe_before_p,out_phe_after_p,out_phe_after90_p)
...
out_proc_diag_med=rbind(out_iCD,out_proc,out_med,out_elix,out_phe)
...
**Number of patients with pheno code after hospitalization due to covid  **
